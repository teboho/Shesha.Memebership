...
using Shesha.Memebership.Tests.DependencyInjection;
using Shesha;
...
namespace Shesha.Memebership.Common.Tests
{
    [DependsOn(
    ...
    public class MemebershipCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public MemebershipCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
