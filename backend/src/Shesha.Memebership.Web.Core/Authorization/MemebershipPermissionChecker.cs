...
namespace Shesha.Memebership.Common.Authorization
{
    /// <summary>
    /// Memebership Permission checker
    /// </summary>
    public class MemebershipPermissionChecker : ICustomPermissionChecker, IMemebershipPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public MemebershipPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
